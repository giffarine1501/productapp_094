...
class _ShowProductPageState extends State<ShowProductPage> {
  ...
  Future<String?> getList() async {
    ...
    products = [];
    var url =
        Uri.parse('https://it-laravel-094.herokuapp.com/api/products');
  ...
  Future<void> deleteProduct(int? id) async {
    SharedPreferences prefs = await _prefs;
    var url =
        Uri.parse('https://it-laravel-094.herokuapp.com/api/products/$id');
  ...
  Future<void> logout() async {
    SharedPreferences prefs = await _prefs;
    var url = Uri.parse('https://it-laravel-094.herokuapp.com/api/logout');
